                        ...
                        <div className="col-xs-12 col-md-10 offset-md-1">
                            ...
                            <div className="article-preview">
                                <div className="article-meta">
                                    <a href="/#/profile/ericsimmons" className="avatar-link">
                                        <img src="http://i.imgur.com/Qr71crq.jpg" className="avatar" alt="Eric Simons" />
                                    </a>
                                    <div className="info">
                            ...
                            <div className="article-preview">
                                <div className="article-meta">
                                    <a href="/#/profile/albertpai" className="avatar-link">
                                        <img src="http://i.imgur.com/N4VcUeJ.jpg" className="avatar" alt="Albert Pai" />
                                    </a>
                                    <div className="info">
